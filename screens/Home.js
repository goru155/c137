...
export default class HomeScreen extends Component {
  ...
  getStarDetails = (name) => {
    const starType = name.star_type;
    let imagePath = "";
    switch (starType) {
      case "star1":
        imagePath = require("../assets/star1.png");
        break;
      case "star2":
        imagePath = require("../assets/star2.png");
        break;
      case "star3":
        imagePath = require("../assets/star3.png");
        break;
      case "star4":
        imagePath = require("../assets/star4.png");
        break;
    }
